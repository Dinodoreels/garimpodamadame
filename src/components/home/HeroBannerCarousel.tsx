  ...
  if (!banners?.length) {
    return (
      <section className={cn("relative overflow-hidden", compact ? "h-[300px] sm:h-[360px] lg:h-[400px]" : "min-h-[70vh] lg:min-h-[85vh]")}>
        ...
        <div className={cn("container relative z-10 flex flex-col items-center justify-center text-center", compact ? "h-full" : "min-h-[70vh] lg:min-h-[85vh]")}>
      ...
      <div ref={emblaRef} className="overflow-hidden h-full">
        <div className="flex h-full">
          {banners.map((banner) => {
            ...
            return (
            <div key={banner.id} className={cn("relative min-w-full flex-shrink-0", compact ? "h-full" : "min-h-[70vh] lg:min-h-[85vh]", banner.click_url && "cursor-pointer")}
              onClick={() => {
                if (banner.click_url) {
