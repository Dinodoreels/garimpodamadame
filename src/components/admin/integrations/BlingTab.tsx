          ...
          {importRun && (
            <>
              ...
              <div className="flex items-center justify-between gap-3">
                <p className="text-xs text-muted-foreground">Produtos com preço e SKU são publicados automaticamente. Itens sem estoque aparecem como ESGOTADO e, quando a plataforma não fornece foto, ficam marcados como sem imagem.</p>
