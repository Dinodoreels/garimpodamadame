...
function ShippingProviderCards({
  ...
  const handleSaveProvider = () => {
    ...
    if (configuring === 'correios') {
      ...
      updated.shipping = { ...shipping, active_provider: 'melhor_envio', melhor_envio: { token: formToken, origin_zip: formOriginZip } };
    }
    onSave(updated);
    setConfiguring(null);
  };
            ...
            {configuring === 'melhor_envio' && (
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input type={showToken ? 'text' : 'password'} value={formToken} onChange={(e) => setFormToken(e.target.value)} placeholder="Seu token do Melhor Envio" className="pr-10" />
                ...
                <p className="text-xs text-muted-foreground">Obtenha em melhorenvio.com.br → Configurações → Tokens</p>
              </div>
            )}
            <div className="space-y-2">
